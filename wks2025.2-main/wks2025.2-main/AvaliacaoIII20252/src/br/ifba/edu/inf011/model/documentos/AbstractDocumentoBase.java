...
public abstract class AbstractDocumentoBase implements Documento{
	...
	public void setNumero(String numero) {
        ...
        public Documento salvar() throws FWDocumentException{
    return new DocumentoMemento(this);
}

public void restaurar(Documento m) throws FWDocumentException {

    this.setConteudo(m.getConteudo());
    this.setNumero(m.getNumero());
    this.inicializar(m.getProprietario(), m.getPrivacidade());
}
